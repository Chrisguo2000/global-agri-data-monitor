...
PRODUCTS = [
    {
        ...
        "usMetric": "us_cattle",
        "comparability": "方向参考",
        "caveat": "中国为集贸牛肉零售/主产活牛价格，美国为NASS农场端肉牛收到价，环节不同。",
    },
    {
        "id": "hog",
        "label": "生猪",
        ...
        "usMetric": "us_hog",
        "comparability": "较可比",
        "caveat": "两边均偏上游价格，但中国为周度集贸市场，美国为月度农场端价格。",
    },
    {
        "id": "milk",
        "label": "生鲜乳",
    ...
    },
    {
        ...
        "usMetric": "us_egg",
        "comparability": "方向参考",
        "caveat": "美国鸡蛋从美元/打按近似重量换算为元/kg，适合趋势对照，不宜做精确价差。",
    },
    {
        "id": "chicken",
        "label": "鸡肉",
        ...
        "usMetric": "us_chicken",
        "comparability": "方向参考",
        "caveat": "中国为集贸鸡肉价格，美国为肉鸡农场端价格，销售环节不同。",
    },
    {
        "id": "corn",
        "label": "玉米",
        ...
        "usMetric": "us_corn",
        "comparability": "较可比",
        "caveat": "均换算为元/kg，但中国为周度集贸/产销区口径，美国为月度农场收到价。",
    },
    {
        "id": "soy",
        "label": "豆粕/大豆",
        ...
        "caveat": "中国指标为豆粕，美国指标为大豆，适合观察饲料蛋白链条方向，不适合直接价差。",
    },
]
...
def main():
    ...
    payload = {
        "meta": {
            ...
            "notes": [
                "中国农业部为周度监测预警，USDA NASS为月度价格收到价。",
                "跨国比较全部统一为元/kg，但采集环节、频率与商品口径不同。",
                "豆粕/大豆仅用于饲料链条方向观察，不直接做商品价差解释。",
            ],
        },
        "countries": {
            "china": {
